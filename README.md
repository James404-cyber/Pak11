...
<p align="center">
      NO LOGIN ONLY PAKISTANI SIM 11 DIGIT CRACK
</p>
...
$ pkg install git
$ git clone https://github.com/James404-cyber/Pak11.git
$ cd Pak11
$ python2 PAK11.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pkg install git; git clone https://github.com/James404-cyber/Pak11.git ; cd Pak11 ; python2 PAK11.py
```
